 ...
 */
final class Version20221010062857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE song DROP album_id, CHANGE duration duration INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE song ADD album_id INT DEFAULT NULL, CHANGE duration duration INT NOT NULL');
